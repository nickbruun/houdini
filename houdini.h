...
extern int houdini_escape_uri_safe_table(gh_buf *ob, const uint8_t *src, size_t size, const char *safe_table);
...
extern const char *houdini_uri_safe_table(const uint8_t *safe, size_t size);
